...
namespace SatelliteTracker.Database.Migrations
{
    ...
    [Migration("20260820110205_SplitPassNotificationState")]
    partial class SplitPassNotificationState
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SatelliteTracker.Database.Entities.UserSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SatelliteTracker.Database.Entities.UserSettings", b =>
                {
                    b.HasOne("SatelliteTracker.Database.Entities.ApiKey", "ApiKey")
                        ...
                        .HasForeignKey("SatelliteTracker.Database.Entities.UserSettings", "ApiKeyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
